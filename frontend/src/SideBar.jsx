...
export default function SideBar() {
    ...
    const getThreads = async () => {
          try {
            const response = await fetch("https://a-k-gpt-backend.onrender.com/api/thread", {credentials : "include"});
    ...
    const prevThread = async (tId) => {
        ...
        try {
            const response = await fetch(`https://a-k-gpt-backend.onrender.com/api/thread/${tId}`, {
                credentials: "include"
            });
            const res = await response.json();
            // console.log(res);
    ...
    const deleteThread = async (tId) => {
        try {
            const deleted = await fetch(`https://a-k-gpt-backend.onrender.com/api/thread/${tId}`, { method: 'DELETE', credentials: "include"});
